                ...
                <Dialog.Panel className='relative flex w-full max-w-xs flex-1 flex-col bg-white pt-5 pb-4'>
                  ...
                  <div className='flex flex-shrink-0 items-center px-4'>
                    <img
                      ...
                      src='/node-rpc-docs-1/images/celestia-logo-purple.png'
                      alt='Celestia Logo'
                    />
                  </div>
              ...
              <div className='py-6'>
                <div className='px-4 sm:px-6 md:px-0'>
                  <div className='lg:flex'>
                    <div className='flex'>
                      <img
                        src='/node-rpc-docs-1/images/icon-1.png'
                        className='h-16'
                        alt='Celestia block'
                      />
                    ...
                    <div className='ml-auto flex'>
                      <a href='https://discord.com/invite/YsnTPcSfWQ'>
                        <img
                          src='/node-rpc-docs-1/images/discord.svg'
                      ...
                      <a href='https://github.com/celestiaorg/celestia-node'>
                        <img
                          src='/node-rpc-docs-1/images/github.svg'
                          className='my-auto h-12'
                          alt='Github Logo'
                        />
                      </a>
