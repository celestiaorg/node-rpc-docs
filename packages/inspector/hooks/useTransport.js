    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!((localTransportType === null || localTransportType === void 0 ? void 0 : localTransportType.type) === "websocket")) return [3 /*break*/, 1];
                localTransport = new client_js_1.WebSocketTransport(uri);
                return [3 /*break*/, 6];
            case 1:
                if (!((localTransportType === null || localTransportType === void 0 ? void 0 : localTransportType.type) === "http")) return [3 /*break*/, 2];
                localTransport = new client_js_1.HTTPTransport(uri, transportOptions);
                return [3 /*break*/, 6];
            case 2:
                if (!((localTransportType === null || localTransportType === void 0 ? void 0 : localTransportType.type) === "postmessageiframe")) return [3 /*break*/, 3];
                localTransport = new client_js_1.PostMessageIframeTransport(uri);
                return [3 /*break*/, 6];
            case 3:
                if (!((localTransportType === null || localTransportType === void 0 ? void 0 : localTransportType.type) === "postmessagewindow")) return [3 /*break*/, 4];
                localTransport = new client_js_1.PostMessageWindowTransport(uri);
                return [3 /*break*/, 6];
            case 4:
                if (!((localTransportType === null || localTransportType === void 0 ? void 0 : localTransportType.type) === "plugin")) return [3 /*break*/, 6];
                return [4 /*yield*/, getTransportFromType(localTransportType.uri, transports, localTransportType.transport)];
            case 5:
                intermediateTransport_1 = _a.sent();
...
var useTransport = function (transports, url, defaultTransportType, transportOptions) {
    var _a = (0, react_1.useState)(), transport = _a[0], setTransport = _a[1];
    var _b = (0, react_1.useState)(false), transportConnected = _b[0], setTransportConnected = _b[1];
    var _c = (0, react_1.useState)(defaultTransportType), transportType = _c[0], setTransportType = _c[1];
